...
func TestIsAuthorized(t *testing.T) {
	t.Parallel()
	cuzco := NewEntityUID("coder", "cuzco")
	dropTable := NewEntityUID("table", "drop")
	tests := []struct {
		Name                        string
		Policy                      string
		Entities                    Entities
	...
	}{
		{
			...
			Principal: cuzco,
			Action:    dropTable,
			Resource:  NewEntityUID("table", "whatever"),
			Context:   Record{},
			Want:      true,
			DiagErr:   0,
		},
		...
		},
		{
			...
			Action:    dropTable,
			Resource:  NewEntityUID("table", "whatever"),
			Context:   NewRecord(RecordMap{"x": Long(42)}),
			Want:      true,
			DiagErr:   0,
		},
		{
			...
			Action:    dropTable,
			Resource:  NewEntityUID("table", "whatever"),
			Context:   NewRecord(RecordMap{"x": Long(43)}),
			Want:      false,
			DiagErr:   0,
		},
		{
			...
			Entities: Entities{
				cuzco: &Entity{
					UID:        cuzco,
					Attributes: NewRecord(RecordMap{"x": Long(42)}),
				},
			},
			Principal: cuzco,
			Action:    dropTable,
		...
		},
		{
			...
			Entities: Entities{
				cuzco: &Entity{
					UID:        cuzco,
					Attributes: NewRecord(types.RecordMap{"x": Long(43)}),
				},
			},
			Principal: cuzco,
			Action:    dropTable,
		...
		},
		{
			...
			Entities: Entities{
				cuzco: &Entity{
					UID:        cuzco,
					Attributes: NewRecord(types.RecordMap{"name": String("bob")}),
				},
			},
			Principal: cuzco,
			Action:    dropTable,
		...
		},
		{
			...
			Entities: Entities{},
			Context:  NewRecord(RecordMap{"value": Long(-42)}),
			Want:     true,
			DiagErr:  0,
		},
		{
			...
			Entities:  Entities{},
			Principal: NewEntityUID("Actor", "cuzco"),
			Action:    NewEntityUID("Action", "drop"),
			Resource:  NewEntityUID("Resource", "table"),
			Context:   Record{},
			Want:      true,
			DiagErr:   0,
		},
		...
		},
		{
			...
			Entities: Entities{
				NewEntityUID("Resource", "table"): &Entity{
					UID:     NewEntityUID("Resource", "table"),
					Parents: []EntityUID{types.NewEntityUID("Parent", "id")},
				},
			},
			Principal: NewEntityUID("Actor", "cuzco"),
			Action:    NewEntityUID("Action", "drop"),
		...
		},
		{
			...
			Entities: Entities{
				NewEntityUID("Principal", "1"): &Entity{
					UID:        NewEntityUID("Principal", "1"),
					Attributes: NewRecord(types.RecordMap{"bar": Long(42)}),
				},
			},
			Principal: NewEntityUID("Principal", "1"),
			Action:    NewEntityUID("Action", "action"),
			Resource:  NewEntityUID("Resource", "resource"),
			Context:   NewRecord(RecordMap{"foo": Long(43)}),
			Want:      true,
			DiagErr:   0,
		},
	}
