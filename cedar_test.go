...
func TestIsAuthorized(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			Principal: types.EntityUID{"coder", "cuzco"},
			Action:    types.EntityUID{"table", "drop"},
			Resource:  types.EntityUID{"table", "whatever"},
			Context:   types.Record{},
			Want:      true,
			DiagErr:   0,
		},
		...
		},
		{
			...
			Entities: entitiesFromSlice([]Entity{
				{
					UID:        types.EntityUID{"coder", "cuzco"},
		...
		},
		{
			...
			Entities: entitiesFromSlice([]Entity{
				{
					UID:     types.EntityUID{"coder", "cuzco"},
					Parents: []types.EntityUID{{"parent", "bob"}},
				},
			}),
			Principal: types.EntityUID{"coder", "cuzco"},
			Action:    types.EntityUID{"table", "drop"},
		...
		},
		{
			...
			Entities: entitiesFromSlice([]Entity{
				{
					UID:     types.EntityUID{"coder", "cuzco"},
					Parents: []types.EntityUID{{"team", "osiris"}},
				},
			}),
			Principal: types.EntityUID{"coder", "cuzco"},
			Action:    types.EntityUID{"table", "drop"},
		...
		},
		{
			...
			Entities: entitiesFromSlice([]Entity{
				{
					UID:     types.EntityUID{"table", "drop"},
					Parents: []types.EntityUID{{"scary", "stuff"}},
				},
			}),
			Principal: types.EntityUID{"coder", "cuzco"},
			Action:    types.EntityUID{"table", "drop"},
		...
		},
		{
			...
			Entities:  entitiesFromSlice(nil),
			Principal: types.EntityUID{"Actor", "cuzco"},
			Action:    types.EntityUID{"Action", "drop"},
			Resource:  types.EntityUID{"Resource", "table"},
			Context:   types.Record{},
			Want:      true,
			DiagErr:   0,
		},
		...
		},
		{
			...
			Entities: entitiesFromSlice([]Entity{
				{
					UID:     types.EntityUID{"Resource", "table"},
					Parents: []types.EntityUID{{"Parent", "id"}},
				},
			}),
			Principal: types.EntityUID{"Actor", "cuzco"},
			Action:    types.EntityUID{"Action", "drop"},
