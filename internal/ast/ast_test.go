...
func TestASTByTable(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			ast.Policy{Effect: ast.EffectPermit, Principal: ast.ScopeTypeAll{}, Action: ast.ScopeTypeAll{}, Resource: ast.ScopeTypeAll{},
				Conditions: []ast.ConditionType{{Condition: ast.ConditionWhen, Body: ast.NodeTypeExtensionCall{Name: "offset", Args: []ast.IsNode{ast.NodeValue{Value: types.NewDatetime(time.Time{})}, ast.NodeValue{Value: types.FromStdDuration(time.Duration(100))}}}}}},
		},
		{
			"opDurationSince",
