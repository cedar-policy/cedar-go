...
func TestToEval(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			types.NewDecimal(42.42),
			testutil.OK,
		},
		{
			"lessThan",
			ast.ExtensionCall("lessThan", ast.Value(types.NewDecimal(42.0)), ast.Value(types.NewDecimal(43))),
			types.True,
			testutil.OK,
		},
		{
			"lessThanOrEqual",
			ast.ExtensionCall("lessThanOrEqual", ast.Value(types.NewDecimal(42.0)), ast.Value(types.NewDecimal(43))),
			types.True,
			testutil.OK,
		},
		{
			"greaterThan",
			ast.ExtensionCall("greaterThan", ast.Value(types.NewDecimal(42.0)), ast.Value(types.NewDecimal(43))),
			types.False,
			testutil.OK,
		},
		{
			"greaterThanOrEqual",
			ast.ExtensionCall("greaterThanOrEqual", ast.Value(types.NewDecimal(42.0)), ast.Value(types.NewDecimal(43))),
			types.False,
			testutil.OK,
		},
		{
