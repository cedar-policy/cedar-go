...
func fold(n ast.IsNode) ast.IsNode {
	...
	case ast.NodeTypeAccess:
		return ast.NodeTypeAccess{StrOpNode: ast.StrOpNode{Arg: fold(v.Arg), Value: v.Value}}
	case ast.NodeTypeHas:
		return ast.NodeTypeHas{StrOpNode: ast.StrOpNode{Arg: fold(v.Arg), Value: v.Value}}
	case ast.NodeTypeLike:
		return ast.NodeTypeLike{Arg: fold(v.Arg), Value: v.Value}
	case ast.NodeTypeIfThenElse:
		return ast.NodeTypeIfThenElse{If: fold(v.If), Then: fold(v.Then), Else: fold(v.Else)}
	case ast.NodeTypeIs:
		return ast.NodeTypeIs{Left: fold(v.Left), EntityType: v.EntityType}
	case ast.NodeTypeIsIn:
		return ast.NodeTypeIsIn{NodeTypeIs: ast.NodeTypeIs{Left: v.Left, EntityType: v.EntityType}, Entity: fold(v.Entity)}
	...
	case ast.NodeTypeNegate:
		return ast.NodeTypeNegate{UnaryNode: ast.UnaryNode{Arg: fold(v.Arg)}}
	case ast.NodeTypeNot:
		return ast.NodeTypeNot{UnaryNode: ast.UnaryNode{Arg: fold(v.Arg)}}
	case ast.NodeTypeVariable:
		// return ast.NodeTypeVariable{Name: v.Name}
		return n
	case ast.NodeTypeIn:
		return ast.NodeTypeIn{BinaryNode: ast.BinaryNode{Left: fold(v.Left), Right: fold(v.Right)}}
	case ast.NodeTypeAnd:
		return ast.NodeTypeAnd{BinaryNode: ast.BinaryNode{Left: fold(v.Left), Right: fold(v.Right)}}
	case ast.NodeTypeOr:
		return ast.NodeTypeOr{BinaryNode: ast.BinaryNode{Left: fold(v.Left), Right: fold(v.Right)}}
	case ast.NodeTypeEquals:
		return ast.NodeTypeEquals{BinaryNode: ast.BinaryNode{Left: fold(v.Left), Right: fold(v.Right)}}
	case ast.NodeTypeNotEquals:
		return ast.NodeTypeNotEquals{BinaryNode: ast.BinaryNode{Left: fold(v.Left), Right: fold(v.Right)}}
	case ast.NodeTypeGreaterThan:
		return ast.NodeTypeGreaterThan{BinaryNode: ast.BinaryNode{Left: fold(v.Left), Right: fold(v.Right)}}
	case ast.NodeTypeGreaterThanOrEqual:
		return ast.NodeTypeGreaterThanOrEqual{BinaryNode: ast.BinaryNode{Left: fold(v.Left), Right: fold(v.Right)}}
	case ast.NodeTypeLessThan:
		return ast.NodeTypeLessThan{BinaryNode: ast.BinaryNode{Left: fold(v.Left), Right: fold(v.Right)}}
	case ast.NodeTypeLessThanOrEqual:
		return ast.NodeTypeLessThanOrEqual{BinaryNode: ast.BinaryNode{Left: fold(v.Left), Right: fold(v.Right)}}
	case ast.NodeTypeSub:
		return ast.NodeTypeSub{BinaryNode: ast.BinaryNode{Left: fold(v.Left), Right: fold(v.Right)}}
	case ast.NodeTypeAdd:
		return ast.NodeTypeAdd{BinaryNode: ast.BinaryNode{Left: fold(v.Left), Right: fold(v.Right)}}
	case ast.NodeTypeMult:
		return ast.NodeTypeMult{BinaryNode: ast.BinaryNode{Left: fold(v.Left), Right: fold(v.Right)}}
	case ast.NodeTypeContains:
		return ast.NodeTypeContains{BinaryNode: ast.BinaryNode{Left: fold(v.Left), Right: fold(v.Right)}}
	case ast.NodeTypeContainsAll:
		return ast.NodeTypeContainsAll{BinaryNode: ast.BinaryNode{Left: fold(v.Left), Right: fold(v.Right)}}
	case ast.NodeTypeContainsAny:
		return ast.NodeTypeContainsAny{BinaryNode: ast.BinaryNode{Left: fold(v.Left), Right: fold(v.Right)}}
	default:
