...
func TestUnmarshalJSON(t *testing.T) {
    ...
    "conditions": [
		...
		},
		{
			...
			ast.Permit().When(ast.String("text").Like(testutil.Must(types.ParsePattern("*")))),
			testutil.OK,
		},
		{
			"like single literal",
			...
			ast.Permit().When(ast.String("text").Like(testutil.Must(types.ParsePattern("foo")))),
			testutil.OK,
		},
		{
		...
		},
		{
			...
			ast.Permit().When(ast.String("text").Like(testutil.Must(types.ParsePattern(`f\*oo*`)))),
			testutil.OK,
		},
		{
			...
			ast.Permit().When(ast.String("text").Like(testutil.Must(types.ParsePattern(`foo*bar`)))),
			testutil.OK,
		},
		{
