...
func TestUnmarshalJSON(t *testing.T) {
    ...
    "conditions": [
		...
		},
		{
			...
			ast.Permit().When(ast.String("text").Like(testutil.Must(ast.PatternFromCedar("*")))),
			testutil.OK,
		},
		{
			"like single literal",
			...
			ast.Permit().When(ast.String("text").Like(testutil.Must(ast.PatternFromCedar("foo")))),
			testutil.OK,
		},
		{
		...
		},
		{
			...
			ast.Permit().When(ast.String("text").Like(testutil.Must(ast.PatternFromCedar(`f\*oo*`)))),
			testutil.OK,
		},
		{
			...
			ast.Permit().When(ast.String("text").Like(testutil.Must(ast.PatternFromCedar(`foo*bar`)))),
			testutil.OK,
		},
		{
